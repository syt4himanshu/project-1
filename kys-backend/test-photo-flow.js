...
async function testPhotoFlow() {
    try {
        ...
        console.log('\nPersonal Info:');
        console.log('- photo_url (DB):', student.personal_info?.photo_url);
        ...
        console.log('- photoUrl (API):', serialized?.photoUrl);
        ...
        console.log('\nDecoded payload:');
        console.log('- personal_info.photoUrl:', decoded.personal_info?.photoUrl);
