        ...
        <div className="space-y-5">
            <section className={sectionCardCls}>
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5">
                    ...
                    {field("Father's WhatsApp Mobile No. *", input('tel', (pi.father_mobile_no as string) || '', v => upd('father_mobile_no', v), 'e.g. 9876543210', getFieldValidation('personal_info.father_mobile_no')))}
                    ...
                    {field("Mother's WhatsApp Mobile No. *", input('tel', (pi.mother_mobile_no as string) || '', v => upd('mother_mobile_no', v), 'e.g. 9876543210', getFieldValidation('personal_info.mother_mobile_no')))}
