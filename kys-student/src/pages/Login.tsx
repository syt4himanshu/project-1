    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
            <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                <h1 className="text-2xl font-bold text-center text-gray-800 dark:text-white mb-2">Student Portal</h1>
                <p className="text-center text-gray-500 dark:text-gray-400 mb-6 text-sm">Know Your Student — KYS</p>
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">UID / Username</label>
                        <input
                            type="text"
                            value={username}
